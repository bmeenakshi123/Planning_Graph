            ...
            for c in self.cargos:
                for p in self.planes:
                    for a in self.airports:
                        ...
                        loads.append(load)
            #print("# of loads:",len(set([(load.name,load.args) for load in loads])))            
            return loads
                ...
                for to in self.airports:
                    if fr != to:
                        for p in self.planes:
                            ...
                            fly = Action(expr("Fly({}, {}, {})".format(p, fr, to)),[precond_pos, precond_neg],[effect_add, effect_rem])
                            flys.append(fly)
            #print("# of fly:",len(set([(fly.name,fly.args) for fly in flys])))
            return flys
